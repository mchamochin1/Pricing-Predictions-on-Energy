...
**SARIMAX** provide the best results as the time series part is more present than the external variables part. If the external variables alone could explain a lot and this complemented by a part of autocorrelation or seasonality, supervised models maight be the better choice... but this is not our case. 
...
Some important events ocurred during the 2001-2009 period of our test sample:
